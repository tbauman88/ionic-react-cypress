      ...
      <IonHeader translucent={true}>
        <IonToolbar>
          <IonButtons slot="start">
            ...
            { !ios &&
              <IonButton data-testid="reset-button" onClick={handleDeselectAll}>Reset</IonButton>
            }
          </IonButtons>
          ...
          <IonButtons slot="end">
            <IonButton data-testid="done-button" onClick={onDismissModal} strong>Done</IonButton>
          </IonButtons>
        </IonToolbar>
      </IonHeader>
